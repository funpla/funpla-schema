...
export type UpdateHandleNameRequest = z.infer<typeof updateHandleNameRequestSchema>;

/** PATCH /users/handle-name のレスポンスボディ */
export const updateHandleNameResponseSchema = z.object({});
export type UpdateHandleNameResponse = z.infer<typeof updateHandleNameResponseSchema>;
